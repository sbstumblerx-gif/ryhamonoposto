...
function DriverPage() {
  ...
  if (q.isError) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-8 text-destructive">
        Virhe ladattaessa kuljettajan tietoja.
      </div>
    );
  }
  ...
  const d = q.data;
  if (!d) {
    return <div className="mx-auto max-w-4xl px-4 py-8">Kuljettajaa ei löydy.</div>;
  }
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        {admin.isAdmin && (
          <div className="card-dark p-3 mb-4 space-y-3">
            ...
            <EditableText
              value={d.content ?? ""}
              multiline
              placeholder="Kuljettajan esittely…"
        ...
        {tab === "info" ? (
          <DriverInfoCard driver={d} isAdmin={admin.isAdmin} />
        ) : (
